    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span9">
                ...
                <h5>INTRODUCE PAYMENT DETAILS</h5>
                <div class="row">
                    <div class="span4">
                        <div class="well">
                            <form action="/user/finish_credit" method="GET" class="form-signin">
                                <div class="control-group">
                                    <div class="controls">
                                        <input name="cardNumber" type="text" class="span3" placeholder="Card Number"/>
                                        <input name="ownerName" type="text" class="span3" placeholder="Owner Name"/>
                                        <input name="cvv" type="text" class="span3" placeholder="CVV2"/>
                                        <input name="expirationDate" type="text" class="span3" placeholder="Expiration Date"/>
                                    </div>
                                </div>
                                <div class="controls">
                                    <button type="submit" class="btn block">Next</button>
                                </div>
                            </form>
                        </div>
                    </div>
